      ...
      <div className="container vendor-container">
        <div className="cta-box glass card-hover flex-row animate-fade-in">
          <div className="cta-content">
            ...
            <button className="cta-button" onClick={() => window.open(import.meta.env.VITE_VENDOR_PORTAL_URL || `http://${window.location.hostname}:3002`, '_blank')}>Register as {selectedPlan} Vendor <ArrowRight size={18} /></button>
          </div>
