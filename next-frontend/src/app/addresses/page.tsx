...
import { ArrowLeft, MapPin, Home, Briefcase, Building2, Plus, Trash2, CheckCircle, Loader2 } from 'lucide-react';
      ...
      <div className="container max-w-md mx-auto p-4 space-y-4">
        {addresses.length === 0 ? (
          <div className="text-center py-16 bg-muted/30 rounded-3xl border border-dashed mt-8">
            ...
            <p className="text-muted-foreground text-sm">Add an address for quick checkout.</p>
          </div>
        ) : (
          addresses.map(addr => (
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <h3 className="font-bold">{addr.label || 'Other'}</h3>
                    {addr.is_default && <span className="bg-primary text-white text-[10px] px-2 py-0.5 rounded-full font-bold">DEFAULT</span>}
                  </div>
