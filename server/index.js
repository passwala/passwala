...
// Fix for local development: Some ISPs (like Jio in India) sinkhole Supabase domains via DNS.
// This patch hardcodes the real Cloudflare anycast IP for Supabase to bypass the ISP block.
if (process.env.NODE_ENV !== 'production') {
  ...
  dns.lookup = function(hostname, options, callback) {
    ...
    if (hostname === 'etwkugpkuhrfryyqmlwx.supabase.co') {
...
app.use(cors({ 
  origin: function (origin, callback) {
    ...
    const isLocalhostOrIP = /https?:\/\/(localhost|127\.0\.0\.1|192\.168\.\d+\.\d+|10\.\d+\.\d+\.\d+|172\.(1[6-9]|2\d|3[01])\.\d+\.\d+):(3000|3001|3002|3003|3004|3005|3006|3010|3011|3012|3013|3015|8000)/.test(origin);
